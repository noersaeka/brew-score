...
const StackAuthNavigator = () => {
	...
	useEffect(() => {
		const checkAppState = async () => {
			...
			const isLoggedIn = await AsyncStorage.getItem('userToken'); // or your auth logic
			...
			if (!hasSeenOnboarding) {
				...
				setInitialScreen('DrawerNavigation');
			}
		};
	...
	if (!initialScreen) return null; // Or a loading spinner
